		...
		<div class="container">
			...
			<div id="actions" class="form-horizontal">
				...
				<div class="pull-right">
					<a class="btn btn-success" id="addComputer" href="<c:url value='/computers/new' />">
				...
				<tbody id="results">
					<c:forEach var="computer" items="${computers}">
						<tr>
							...
							<td><a href="<c:url value='/computers/${computer.id}' />"
		...
		<div class="btn-group btn-group-sm pull-right" role="group">
			<c:forEach var="record" items="10,50,100">
				<a type="button" class="btn btn-default"
					href=<tags:link target="computers" page="${currentPage}" limit="${record}"
