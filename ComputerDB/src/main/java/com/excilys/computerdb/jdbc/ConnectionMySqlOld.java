 ...
 * @author ecayez
 */
public class ConnectionMySqlOld {
  ...
  private static ConnectionMySqlOld connectionMySQL;
  ...
  static {
    ...
    connectionMySQL = new ConnectionMySqlOld(connectionPool);
  }
   ...
   */
  private ConnectionMySqlOld(BoneCP connectionPool) {
    this.connectionPool = connectionPool;
  }

  public static ConnectionMySqlOld getInstance() {
